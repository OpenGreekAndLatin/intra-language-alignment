...
<div class="warpper">
<div class="headDiv">
	<h1><img src="images/logo_dh_light.png" height="80"><b>Intra-Language Alignment </b>(Single Alignment) <img src="images/lavori-in-corso.png" height="90" align="right"></h1> 
</div>
...
<form>
	...
	<label class="checkbox-inline"><input type="checkbox" name="punctuation" value="1" <?php if($_REQUEST['punctuation']==1) echo "checked";?>>Ignore non alphanumeric characters</label>
